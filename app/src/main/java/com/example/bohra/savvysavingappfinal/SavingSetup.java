 ...
 * It includes a calender function for setting the date and will be used to show users how close they are
...
public class SavingSetup extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        /*
        *Constraint listener for checking whether data has been entered by the user for setting a saving goal.
        *This prompts the user to input a valid value before continuing to the home screen.
        */
